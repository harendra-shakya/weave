      ...
      <div className="grid cols-2" style={{ alignItems: "start" }}>
        <div>
          <div className="panel">
            ...
            <div className="row" style={{ borderColor: home.source === "fixture" ? "var(--accent)" : undefined }}>
              <div>
                <div className="sec">Fixture data {home.source === "fixture" && "· selected"}</div>
                <div className="muted" style={{ fontSize: "var(--fs-sm)" }}>bundled demo home</div>
              </div>
            </div>
            <div className="row">
              <div>
                <div className="sec">Live local WEAVE home {home.source === "live" && "· selected"}</div>
            ...
            <div className="kv" style={{ marginTop: 10 }}>
              ...
              <span className="mono muted">{home.source_path}</span>
            </div>
          </div>
        ...
        <div className="panel">
          <div className="h2">Mirrors / Couriers</div>
